...
public class CreateAnimalServiceImpl implements ICreateAnimalService {
    ...
    public void createAnimalFromParent() throws InvalidAnimalBirthDateException {
        ICreateAnimalService.super.createAnimal();
    }

    @Override
    public void createAnimal() throws InvalidAnimalBirthDateException {
    ...
    public void createAnimal(final int number) throws InvalidAnimalBirthDateException {
        ISearchService searchService = new SearchServiceImpl();
