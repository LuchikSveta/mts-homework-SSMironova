...
public abstract class AbstractAnimal implements IAnimal {
    ...
    public AbstractAnimal(final String name, final String breed, final double cost, final String character, final String birthDate, final String secretInformation) {
        this.type = getClass().getSimpleName();
        this.name = name;
        this.breed = breed;
        this.cost = cost;
