package ru.mts.siebel.app.service;
...
import ru.mts.siebel.starter.service.SearchServiceImpl;
...
class SearchServiceImplTest {
    ...
    void checkLeapYearAnimalWithDateException(final AbstractAnimal animal) {
        ...
        assertEquals("У животного " + animal.getType().toUpperCase() + " не указана дата его рождения", exception.getMessage());
    }
